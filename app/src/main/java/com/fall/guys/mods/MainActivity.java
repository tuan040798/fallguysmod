...
public class MainActivity extends AppCompatActivity {
    ...
    private void insertAdsInMenuItems() {
        ...
        RecyclerViewFragment.mRecyclerViewItems =mRecyclerViewItems;
    ...
    private void addMenuItemsFromJson() {
        try {
            ...
            for (int i = 0; i < menuItemsJsonArray.length(); ++i) {
                ...
                String img = menuItemObject.getString("img");
                String download = menuItemObject.getString("download");

                MenuItem menuItem = new MenuItem(name, photo, img, download);
